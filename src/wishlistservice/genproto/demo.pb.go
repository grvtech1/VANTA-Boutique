...
const (
	StockStatus_IN_STOCK     StockStatus = 0
	StockStatus_LOW_STOCK    StockStatus = 1
	StockStatus_OUT_OF_STOCK StockStatus = 2
)
...
func (x *Review) GetCreatedAtUnix() int64 {
	if x != nil {
...
type GetReviewsResponse struct {
	...
	// Mean of all ratings for the product (0 when there are none).
...
func (x *GetReviewsResponse) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *AddReviewRequest) GetAuthor() string {
	if x != nil {
		return x.Author
	}
	return ""
...
type WishlistItem struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	ProductId string                 `protobuf:"bytes,1,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`
	// When the item was saved, as a Unix epoch (seconds).
	AddedAtUnix   int64 `protobuf:"varint,2,opt,name=added_at_unix,json=addedAtUnix,proto3" json:"added_at_unix,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WishlistItem) GetAddedAtUnix() int64 {
	if x != nil {
...
type StockLevel struct {
	...
	ProductId string                 `protobuf:"bytes,1,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`
	Quantity  int32                  `protobuf:"varint,2,opt,name=quantity,proto3" json:"quantity,omitempty"`
	// Quantities at or below this threshold are reported as LOW_STOCK.
	...
	Status            StockStatus `protobuf:"varint,4,opt,name=status,proto3,enum=hipstershop.StockStatus" json:"status,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *StockLevel) GetLowStockThreshold() int32 {
	if x != nil {
...
func (x *StockLevel) GetStatus() StockStatus {
	if x != nil {
		return x.Status
	}
	return StockStatus_IN_STOCK
}
...
type ListStockRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Empty means every product the service knows about.
	ProductIds    []string `protobuf:"bytes,1,rep,name=product_ids,json=productIds,proto3" json:"product_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListStockRequest) GetProductIds() []string {
	if x != nil {
		return x.ProductIds
	}
	return nil
...
func (x *ListStockResponse) GetLevels() []*StockLevel {
	if x != nil {
		return x.Levels
	}
	return nil
...
const file_demo_proto_rawDesc = "" +
	...
	"\x0fcreated_at_unix\x18\x06 \x01(\x03R\rcreatedAtUnix\"2\n" +
	"\x11GetReviewsRequest\x12\x1d\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\"\x80\x01\n" +
	"\x12GetReviewsResponse\x12-\n" +
	"\areviews\x18\x01 \x03(\v2\x13.hipstershop.ReviewR\areviews\x12%\n" +
	"\x0eaverage_rating\x18\x02 \x01(\x02R\raverageRating\x12\x14\n" +
	...
	"\x06review\x18\x01 \x01(\v2\x13.hipstershop.ReviewR\x06review\"Q\n" +
	"\fWishlistItem\x12\x1d\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\x12\"\n" +
	"\radded_at_unix\x18\x02 \x01(\x03R\vaddedAtUnix\"T\n" +
	"\bWishlist\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12/\n" +
	"\x05items\x18\x02 \x03(\v2\x19.hipstershop.WishlistItemR\x05items\"P\n" +
	...
	"\x13low_stock_threshold\x18\x03 \x01(\x05R\x11lowStockThreshold\x120\n" +
	"\x06status\x18\x04 \x01(\x0e2\x18.hipstershop.StockStatusR\x06status\"0\n" +
	...
	"\x06levels\x18\x01 \x03(\v2\x17.hipstershop.StockLevelR\x06levels*<\n" +
	"\vStockStatus\x12\f\n" +
	"\bIN_STOCK\x10\x00\x12\r\n" +
	"\tLOW_STOCK\x10\x01\x12\x10\n" +
	"\fOUT_OF_STOCK\x10\x022\xca\x01\n" +
	"\vCartService\x12<\n" +
	...
	"\tAdService\x12;\n" +
	"\x06GetAds\x12\x16.hipstershop.AdRequest\x1a\x17.hipstershop.AdResponse\"\x002\xaf\x01\n" +
	"\x0eReviewsService\x12O\n" +
	"\n" +
	"GetReviews\x12\x1e.hipstershop.GetReviewsRequest\x1a\x1f.hipstershop.GetReviewsResponse\"\x00\x12L\n" +
	"\tAddReview\x12\x1d.hipstershop.AddReviewRequest\x1a\x1e.hipstershop.AddReviewResponse\"\x002\xf2\x01\n" +
	"\x0fWishlistService\x12G\n" +
	"\aAddItem\x12#.hipstershop.AddWishlistItemRequest\x1a\x15.hipstershop.Wishlist\"\x00\x12M\n" +
	"\n" +
	"RemoveItem\x12&.hipstershop.RemoveWishlistItemRequest\x1a\x15.hipstershop.Wishlist\"\x00\x12G\n" +
	"\vGetWishlist\x12\x1f.hipstershop.GetWishlistRequest\x1a\x15.hipstershop.Wishlist\"\x002\xa5\x01\n" +
	"\x10InventoryService\x12C\n" +
	"\bGetStock\x12\x1c.hipstershop.GetStockRequest\x1a\x17.hipstershop.StockLevel\"\x00\x12L\n" +
	"\tListStock\x12\x1d.hipstershop.ListStockRequest\x1a\x1e.hipstershop.ListStockResponse\"\x00B0Z.github.com/grvtech1/VANTA-Boutique/hipstershopb\x06proto3"
...
var file_demo_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_demo_proto_goTypes = []any{
	(StockStatus)(0),                       // 0: hipstershop.StockStatus
	...
	(*Review)(nil),                         // 33: hipstershop.Review
	(*GetReviewsRequest)(nil),              // 34: hipstershop.GetReviewsRequest
	(*GetReviewsResponse)(nil),             // 35: hipstershop.GetReviewsResponse
	(*AddReviewRequest)(nil),               // 36: hipstershop.AddReviewRequest
	(*AddReviewResponse)(nil),              // 37: hipstershop.AddReviewResponse
	(*WishlistItem)(nil),                   // 38: hipstershop.WishlistItem
	(*Wishlist)(nil),                       // 39: hipstershop.Wishlist
	(*AddWishlistItemRequest)(nil),         // 40: hipstershop.AddWishlistItemRequest
	(*RemoveWishlistItemRequest)(nil),      // 41: hipstershop.RemoveWishlistItemRequest
	(*GetWishlistRequest)(nil),             // 42: hipstershop.GetWishlistRequest
	(*StockLevel)(nil),                     // 43: hipstershop.StockLevel
	(*GetStockRequest)(nil),                // 44: hipstershop.GetStockRequest
	(*ListStockRequest)(nil),               // 45: hipstershop.ListStockRequest
	(*ListStockResponse)(nil),              // 46: hipstershop.ListStockResponse
}
var file_demo_proto_depIdxs = []int32{
	...
	33, // 23: hipstershop.GetReviewsResponse.reviews:type_name -> hipstershop.Review
	33, // 24: hipstershop.AddReviewResponse.review:type_name -> hipstershop.Review
	38, // 25: hipstershop.Wishlist.items:type_name -> hipstershop.WishlistItem
	0,  // 26: hipstershop.StockLevel.status:type_name -> hipstershop.StockStatus
	43, // 27: hipstershop.ListStockResponse.levels:type_name -> hipstershop.StockLevel
	...
	6,  // 37: hipstershop.CurrencyService.GetSupportedCurrencies:input_type -> hipstershop.Empty
	21, // 38: hipstershop.CurrencyService.Convert:input_type -> hipstershop.CurrencyConversionRequest
	23, // 39: hipstershop.PaymentService.Charge:input_type -> hipstershop.ChargeRequest
	27, // 40: hipstershop.EmailService.SendOrderConfirmation:input_type -> hipstershop.SendOrderConfirmationRequest
	28, // 41: hipstershop.CheckoutService.PlaceOrder:input_type -> hipstershop.PlaceOrderRequest
	30, // 42: hipstershop.AdService.GetAds:input_type -> hipstershop.AdRequest
	34, // 43: hipstershop.ReviewsService.GetReviews:input_type -> hipstershop.GetReviewsRequest
	36, // 44: hipstershop.ReviewsService.AddReview:input_type -> hipstershop.AddReviewRequest
	40, // 45: hipstershop.WishlistService.AddItem:input_type -> hipstershop.AddWishlistItemRequest
	41, // 46: hipstershop.WishlistService.RemoveItem:input_type -> hipstershop.RemoveWishlistItemRequest
	42, // 47: hipstershop.WishlistService.GetWishlist:input_type -> hipstershop.GetWishlistRequest
	44, // 48: hipstershop.InventoryService.GetStock:input_type -> hipstershop.GetStockRequest
	45, // 49: hipstershop.InventoryService.ListStock:input_type -> hipstershop.ListStockRequest
	...
	35, // 65: hipstershop.ReviewsService.GetReviews:output_type -> hipstershop.GetReviewsResponse
	37, // 66: hipstershop.ReviewsService.AddReview:output_type -> hipstershop.AddReviewResponse
	39, // 67: hipstershop.WishlistService.AddItem:output_type -> hipstershop.Wishlist
	39, // 68: hipstershop.WishlistService.RemoveItem:output_type -> hipstershop.Wishlist
	39, // 69: hipstershop.WishlistService.GetWishlist:output_type -> hipstershop.Wishlist
	43, // 70: hipstershop.InventoryService.GetStock:output_type -> hipstershop.StockLevel
	46, // 71: hipstershop.InventoryService.ListStock:output_type -> hipstershop.ListStockResponse
