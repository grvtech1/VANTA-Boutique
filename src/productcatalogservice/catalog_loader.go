...
import (
	...
	pb "github.com/grvtech1/VANTA-Boutique/src/productcatalogservice/genproto"
	"github.com/golang/protobuf/jsonpb"
)

// loadCatalog reads the catalog from the bundled products.json. The catalog is
// immutable data shipped inside the image, so no external database is involved.
